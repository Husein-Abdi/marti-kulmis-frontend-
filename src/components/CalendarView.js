...
export const CalendarView = () => {
  ...
  return (
    <div className="my-12">
<div className="flex items-center justify-center w-auto mb-10">
...
<h1 className="mb-4 ml-3 text-xl font-black leading-7 text-center text-gray-800 sm:text-3xl md:text-4xl lg:text-3xl xl:text-3xl md:leading-10">
          Filters </h1>
          {/* <h1 className="ml-3 text-xl font-black leading-7 text-center text-indigo-700 sm:text-3xl md:text-4xl lg:text-3xl xl:text-3xl md:leading-10">
          Filters </h1> */}
...
<button
          ...
          <div className="col-span-2 md:px-7">
            ...
            <div className="grid grid-cols-7 mt-2 text-sm">
              {days.map((day, dayIdx) => (
                <div
                  ...
                  <div className="w-auto h-1 mx-auto mt-1 ">
...
function Meeting({ events }) {
  ...
  return (
    <>
      <li className="flex max-w-md mx-4 mb-5 bg-white rounded-lg shadow-xl md:mx-auto md:max-w-2xl ">
        <div class="flex items-start px-4 py-6">
          <div class="">
            ...
            <div class="flex items-center  my-3">
              <MdLocationPin className="mr-2 text-gray-700 " />
            ...
            <div class="flex items-center mb-3">
              <MdDateRange className="mr-2 text-gray-700 " />
            ...
            {events.eventDateType === "multiple" && (
              <>
                <div className="flex items-center ">
                  <p className="mr-2 font-bold text-gray-600 ">From</p>
                ...
                <div className="flex items-center ">
                  <p className="mr-2 font-bold text-gray-600 ">To</p>
            ...
            {events.eventDateType === "half" && (
              <>
                <div className="my-3">
                  <div className="flex items-center ">
                    <p className="mr-2 font-bold text-gray-600 text-m">From</p>
                  ...
                  <div className="flex items-center ">
                    <p className="mr-2 font-bold text-gray-600 ext-m">To</p>
